...
bool size5alignment1array() {
  ...
  ASSERT_TRUE(run_fidl_transform(
      &v1_example_Size5Alignment1ArrayTable,
      &example_Size5Alignment1ArrayTable,
...
bool size5alignment4array() {
  ...
  ASSERT_TRUE(run_fidl_transform(
      &v1_example_Size5Alignment4ArrayTable,
      &example_Size5Alignment4ArrayTable,
...
bool size5alignment1vector() {
  ...
  ASSERT_TRUE(run_fidl_transform(
      &v1_example_Size5Alignment1VectorTable,
      &example_Size5Alignment1VectorTable,
...
bool size5alignment4vector() {
  ...
  ASSERT_TRUE(run_fidl_transform(
      &v1_example_Size5Alignment4VectorTable,
      &example_Size5Alignment4VectorTable,
